...
::: block
![From \cite{li2023reconstructing}](fig/chap8/phylogenetic_goal1.png){#fig-phylogenetic-goal1 width="100%" fig-align="center"}
:::
...
[^3]: You can approximate $n!$ by $n^n$. See <https://proofwiki.org/wiki/Lower_and_Upper_Bound_o_Factorial> or <https://en.wikipedia.org/wiki/Stirlings_approximation>.
...
See \cite{vanhorn2021next,li2023reconstructing,zhang2024advancements} for fantastic overviews on both types of technologies.
