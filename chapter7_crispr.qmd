...
Remember: If we use a low MOI (ex: MOI of 0.3) experiment, we need *many* cells to receive each guide, and we *even more* cells because most cells won't receive a guide. To quote @bock2022high,
