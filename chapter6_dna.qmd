...
::: block
![**Single nucleotide variation (SNV) across individuals.** From <https://www.genome.gov/about-genomics/educational-resources/fact-sheets/human-genomic-variation>.](fig/chap6/snp1.png){#fig-snp width="100%" fig-align="center"}
:::
...
::: block
![**Effects of SNPs in coding, noncoding, and regulatory regions.** From <https://www.biointeractive.org/sites/default/files/media/file/2020-02/MappingGenesSNP-StudentHO-act.pdf>.](fig/chap6/gene_snp.png){#fig-gene-snp width="100%" fig-align="center"}
:::
...
::: block
![All from [UCSC Genome Browser](https://genome.ucsc.edu/cgi-bin/hgTracks?db=hg38&lastVirtModeType=default&lastVirtModeExtraState=&virtModeType=default&virtMode=0&nonVirtPosition=&position=chr19%3A44905796%2D44909393&hgsid=1906883924_WxRmL3T84AjPZVHeWbs1xUmoHbMh): Viewing the entire APOE gene (notice that the scale is roughly 1 kb of basepairs).](fig/chap6/ucsc1.png){#fig-ucsc1 width="100%" fig-align="center"}
:::

::: block
![: Zoomed in, scale of roughly 20 base pairs, where you can see the specific DNA sequence now. This is the base-pair sequence of the reference genome (here, hg38) from the 5'-to-3' side of the DNA.](fig/chap6/ucsc2.png){#fig-ucsc2 width="100%" fig-align="center"}
:::

::: block
![: Zoomed out, scale of roughly 100 kb base pairs, where you can see many other genes.](fig/chap6/ucsc3.png){#fig-ucsc3 width="100%" fig-align="center"}
:::
...
::: block
![**Nucleotide structure showing 5′ to 3′ directionality.** From <https://en.wikipedia.org/wiki/Directionality_(molecular_biology)>.](fig/chap6/5-to-3.png){#fig-5-to-3-1 width="70%" fig-align="center"}
:::

::: block
![ **Transcription: RNA synthesis from DNA template strand.** From <https://www.columbia.edu/cu/biology/courses/c2005/lectures/lec13_10.html>.](fig/chap6/gene_side2.png){#fig-5-to-3-2 width="100%" fig-align="center"}
:::

::: block
![ **Coding vs. template strand during transcription.** From <https://sandwalk.blogspot.com/2007/03/gene-and-transcription-orientation.html>.](fig/chap6/gene_side1.png){#fig-5-to-3-3 width="100%" fig-align="center"}
:::
...
::: block
![**GWAS plot: phenotype association with SNP alleles.** From <https://en.wikipedia.org/wiki/Genome-wide_association_study>.](fig/chap6/gwas.png){#fig-gwas width="100%" fig-align="center"}
:::

::: block
![**Manhattan plot of genome-wide SNP associations.** From @kunkle2019genetic.](fig/chap6/manhattan.png){#fig-manhattan width="100%" fig-align="center"}
:::
...
::: block
![**Fine-mapping: locus-level vs. variant-level interpretation.** From @wang2022methods.](fig/chap6/pip.png){#fig-pip width="100%" fig-align="center"}
:::

::: block
![**Association vs. fine-mapping with CARMA (Z-scores and PIP).** From @yang2023carma.](fig/chap6/carma.png){#fig-carma width="100%" fig-align="center"}
:::
...
::: block
![**Types of genomic variation: insertion, SNV, deletion, tandem repeats.** From <https://www.genome.gov/about-genomics/educational-resources/fact-sheets/human-genomic-variation>.](fig/chap6/genetic-variation1.png){#fig-genetic-variation1 width="100%" fig-align="center"}
:::

::: block
![**Structural variation in genomes: deletion, inversion, duplication, insertion.** From <https://sangerinstitute.blog/2023/05/10/a-representative-reference-genome/>.](fig/chap6/genetic-variation2.png){#fig-genetic-variation2 width="100%" fig-align="center"}
:::

::: block
![**Chromosomal structural variants: deletion, duplication, inversion, insertion, translocation.** From <https://www.genome.gov/about-genomics/educational-resources/fact-sheets/human-genomic-variation>.](fig/chap6/structural-variation.png){#fig-structural-variation width="100%" fig-align="center"}
:::

::: block
![**Counts of variant types in the human genome.** From <https://www.genome.gov/about-genomics/educational-resources/fact-sheets/human-genomic-variation>.](fig/chap6/genetic-variation3.png){#fig-genetic-variation3 width="100%" fig-align="center"}
:::

::: block
![**Proportion of variable vs. non-variable genome regions.** From <https://www.genome.gov/about-genomics/educational-resources/fact-sheets/human-genomic-variation>.](fig/chap6/genetic-variation4.png){#fig-genetic-variation4 width="100%" fig-align="center"}
:::
...
::: block
![**Sequencing reads showing SNP detection.** From <https://online.stat.psu.edu/stat555/node/106/>.](fig/chap6/snp-calling.png){#fig-snp-calling width="100%" fig-align="center"}
:::
...
::: block
![ From <https://www.hammerlab.org/2015/01/23/faster-pileup-loading-with-bai-indices/>. This shows an explicit colored callout of the SNPs relative to the reference genome.](fig/chap6/igv2.png){#fig-igv1-bottom width="100%" fig-align="center"}
:::

::: block
![**Visualization of structural variants (insertions and deletions) using PacBio long-read sequencing in IGV.** From <https://www.pacb.com/blog/igv-3-improves-support-pacbio-long-reads/>.](fig/chap6/igv3.png){#fig-igv3 width="100%" fig-align="center"}
:::
...
::: block
![**cis- vs. trans-eQTL effects of SNPs on gene expression.** From @zhuang2019development.](fig/chap6/eqtl.png){#fig-eqtl width="100%" fig-align="center"}
:::
...
::: block
![**GWAS fine-mapping with chromatin accessibility (ATAC-seq).** From @sheth2024mapping.](fig/chap6/gwas-atac.png){#fig-gwas-atac width="100%" fig-align="center"}
:::

::: block
![**Benchmarking data sources: CRISPR, eQTL, GWAS (advantages/limitations).** From @sheth2024mapping.](fig/chap6/eqtl-gwas.png){#fig-eqtl-gwas width="100%" fig-align="center"}
:::
...
::: block
![**Epistasis in coat color genetics (mouse Punnett square).** From <https://en.wikipedia.org/wiki/Epistasis>](fig/chap6/epistasis.png){#fig-epistasis width="100%" fig-align="center"}
:::
...
::: block
![**Enformer deep learning model for DNA sequence to functional predictions.** From Enformer, @avsec2021effective.](fig/chap6/s2f1.png){#fig-s2f1 width="100%" fig-align="center"}
:::

::: block
![**Deep learning models predicting gene regulation from sequence (RNA-seq, ATAC-seq, ChIP-seq).** From @sasse2023benchmarking.](fig/chap6/s2f2.png){#fig-s2f2 width="100%" fig-align="center"}
:::
...
::: block
![**Polygenic risk score (PRS) development and stratification pipeline.** From @kennedy2022genetic.](fig/chap6/prs2.png){#fig-prs1 width="100%" fig-align="center"}
:::

::: block
![**PRS scale illustrating low- vs. high-risk patients.** From @hernandez2019genomics.](fig/chap6/prs1.png){#fig-prs2 width="100%" fig-align="center"}
:::

::: block
![**Global representation in GWAS studies by ancestry.** From @martin2019clinical.](fig/chap6/prs_ethnicity.png){#fig-prs_ethnicity1 width="100%" fig-align="center"}
:::

::: block
![**LD structure differences across populations (European vs. African).** From @wall2003haplotype.](fig/chap6/linkeage-disequilibrium.png){#fig-prs_ethnicity2 width="100%" fig-align="center"}
:::
...
::: block
![**TWAS framework linking SNPs, gene expression, and traits.** From @wainberg2019opportunities.](fig/chap6/twas.png){#fig-twas width="100%" fig-align="center"}
:::
...
::: block
![**Mendelian randomization assumptions for causal inference.** From @li2021genetically.](fig/chap6/mr2.png){#fig-mr1 width="100%" fig-align="center"}
:::

::: block
![**Two-sample Mendelian randomization model (ratio estimate + IVW meta-analysis).** From @barry2021exploiting.](fig/chap6/mr1.png){#fig-mr2 width="100%" fig-align="center"}
:::
...
::: block
![**Copy number variation detection via read depth spikes.** From <https://learngenomics.dev/docs/genomic-variation/copy-number-variation>.](fig/chap6/cnv.png){#fig-cnv width="100%" fig-align="center"}
:::

::: block
![**Reference vs. test genome alignment showing duplications and deletions (CNVs).** From @xing2020secnvs.](fig/chap6/cnv_wes.png){#fig-cnv_wes1 width="100%" fig-align="center"}
:::

::: block
![**Coverage depth patterns revealing allele-specific CNVs.** From @singh2021detecting.](fig/chap6/cnv_wes2.png){#fig-cnv_wes2 width="100%" fig-align="center"}
:::
...
::: block
![**Sequencing technologies compared: short-read, long-read, ultra-long-read, BioNano, Hi-C.** From @garg2021computational.](fig/chap6/longread.png){#fig-longread width="100%" fig-align="center"}
:::
...
::: block
![**SCCNV Normalization pipeline for CNV detection (depth, GC, amplification bias, smoothing).** From @dong2020sccnv.](fig/chap6/cnv_pipeline.png){#fig-cnv_pipeline width="100%" fig-align="center"}
:::
...
::: block
![**Molecular haplotyping techniques and phasing (MEC approaches).** From @garg2021computational.](fig/chap6/phasing1.png){#fig-phasing1 width="100%" fig-align="center"}
:::

::: block
![**Fragment matrix partitioning for haplotype reconstruction (wMEC).** From @tangherloni2019genhap.](fig/chap6/phasing2.png){#fig-phasing2 width="100%" fig-align="center"}
:::
...
::: block
![**CNV detection using NanoGLADIATOR: cancer vs. healthy cfDNA profiles in nocontrol mode (panel of normals) and paired mode (matched normal).** From @martignano2021nanopore.](fig/chap6/cnv_paired.png){#fig-cnv_paired width="100%" fig-align="center"}
:::
...
::: block
**Remark: (The reference genome is not a ‘healthy’ genome, ‘nor the most common, nor the longest, nor an ancestral haplotype’.)**  
 Efforts to fix these ‘errors’ include adjusting alleles to the preferred or major allele or the use of targeted and ethnically matched genomes.
:::
...
::: block
![**Amplification artifacts in single-cell sequencing: errors in assembly, CNV, and SNV detection.** From @gawad2016single.](fig/chap6/single-cell-dna1.png){#fig-single-cell-dna1 width="100%" fig-align="center"}
:::

::: block
![**Bulk vs. single-cell sequencing: allele dropout, imbalance, locus dropout, amplification error.** From @valecha2022somatic.](fig/chap6/single-cell-dna2.png){#fig-single-cell-dna2 width="100%" fig-align="center"}
:::
...
::: block
![**Single-cell CNV inference workflow: normalization, baseline definition, segmentation, clustering.** From @gao2021delineating.](fig/chap6/copykat.png){#fig-copykat width="100%" fig-align="center"}
:::
...
::: block
![**Short tandem repeats (STRs): variation in repeat counts across individuals.** From <https://www.sciencedirect.com/topics/immunology-and-microbiology/short-tandem-repeat>.](fig/chap6/str-example1.png){#fig-str-example1a width="100%" fig-align="center"}
:::

::: block
![**Repeat expansion: increasing CAG repeats linked to earlier onset and greater severity.** From <https://uoftmedicalgenomics.home.blog/2022/05/05/slipping-into-the-dna-architecture-of-tandem-repeat-expansion-disorders/>.](fig/chap6/str-function3.png){#fig-str-example1b width="100%" fig-align="center"}
:::

::: block
![**Pathogenic vs. healthy repeat ranges across repeat expansion disorders.** From @chintalaphani2021update.](fig/chap6/str-range.png){#fig-str-range width="100%" fig-align="center"}
:::
...
::: block
![**Genomic locations of repeat expansions (promoter, UTR, intron, coding sequence).** From @sznajder2019short.](fig/chap6/str-disease1.png){#fig-str-disease1 width="100%" fig-align="center"}
:::

::: block
![**Repeat expansion disorders mapped to STR locations in genome regions.** From @doss2025mosaicism.](fig/chap6/str-disease2.png){#fig-str-disease2 width="100%" fig-align="center"}
:::

::: block
![**Huntington’s disease: CAG repeat expansion alters protein structure and function.** From <https://dnascience.plos.org/2021/09/02/new-target-for-treating-huntingtons-disease-controlling-runaway-dna-repair/>.](fig/chap6/str-hd.png){#fig-str-hd width="100%" fig-align="center"}
:::
...
::: block
![**Repeat expansion disorders across genome regions (5′ UTR, intron, exon, 3′ UTR) and resulting RNA/protein products.** From @hannan2018tandem.](fig/chap6/str-location.png){#fig-str-location width="100%" fig-align="center"}
:::

::: block
![**Expanded STRs in promoters, enhancers, and splicing affecting gene regulation.** From @tanudisastro2024sequencing.](fig/chap6/str-function.png){#fig-str-function width="100%" fig-align="center"}
:::

::: block
![**Pathogenic mechanisms of repeat expansions: chromatin, transcription, RNA processing, RAN translation, protein misfolding.** From @wright2023native.](fig/chap6/str-function2.png){#fig-str-function2 width="100%" fig-align="center"}
:::

::: block
![**Association between STR length and gene expression across different loci.** From @fotsing2019impact.](fig/chap6/str-gene-expression.png){#fig-str-gene-expression width="100%" fig-align="center"}
:::

::: block
![**eSTR analysis pipeline: genotype STRs, profile expression/phenotype, identify expression-linked STRs.** From @tanudisastro2024sequencing.](fig/chap6/str-gene-expression2.png){#fig-str-gene-expression2 width="100%" fig-align="center"}
:::

::: block
![**Sequencing technologies for STR detection: short-read, Nanopore, PacBio HiFi.** From @chintalaphani2021update.](fig/chap6/longread2.png){#fig-longread2 width="100%" fig-align="center"}
:::
